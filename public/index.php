...
<body>
  ...
  <div class="content" style="padding:0px;overflow:hidden">
    ...
    <iframe id="umap" width="100%" height="300px" frameborder="0" allowfullscreen allow="geolocation" src="https://umap.openstreetmap.fr/en/map/animal-rights-map_487135?scaleControl=false&miniMap=false&scrollWheelZoom=true&zoomControl=true&allowEdit=false&moreControl=false&searchControl=true&tilelayersControl=false&embedControl=false&printControl=false&datalayersControl=expanded&onLoadPanel=none&captionBar=false&fullscreenControl=false&locateControl=true&measureControl=false" style="overflow:hidden;height:100%;width:100%" height="100%" width="100%"></iframe>
  </div>
  ...
  <template id="group-submission-modal">
    ...
    <swal-html>
      <form id="group-submission-form">
        <input required type="text" id="name" class="swal2-input" placeholder="Your name">
        <input required type="email" id="email" class="swal2-input" placeholder="Your email">
  ...
  <template id="group-submission-success">
    <swal-html>
